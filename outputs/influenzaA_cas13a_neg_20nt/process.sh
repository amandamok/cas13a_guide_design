...
Rscript ${script_dir}/break_genome.R -i ${ref_dir}/influenzaA_human_allSegments_consensus.fa \
    -w 20 -e Cas13a -g - -s -

# score sensitivity to reference genome segments
Rscript ${script_dir}/score_influenza_sensitivity.R -t influenzaA -m 1 -w 20

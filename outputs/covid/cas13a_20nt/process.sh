...
Rscript ~/cas13a_guide_design/scripts/break_genome.R -w 20 -e Cas13a
...
# summarize results
Rscript -e 'rmarkdown::render("cas13a_results_summary_test20.Rmd", quiet=T)'
Rscript -e 'rmarkdown::render("cas13a_results_summary_highViralAbundance.Rmd", quiet=T)'
Rscript -e 'rmarkdown::render("cas13a_results_summary_ampliconOverlap.Rmd", quiet=T)'

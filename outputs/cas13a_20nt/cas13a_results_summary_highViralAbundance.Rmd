...
previous_order <- readLines("~/covid-19/outputs/spacers_20200427.txt")
...
write.table(subset_5, quote=F, row.names=F, sep="\t",
            file=paste0("~/covid-19/outputs/cas13a_20nt/guides_3prime_", format(Sys.time(), "%Y%m%d"), ".txt"))
```
...
write.table(subset_6, quote=F, row.names=F, sep="\t",
            file=paste0("~/covid-19/outputs/cas13a_20nt/guides_5prime_", format(Sys.time(), "%Y%m%d"), ".txt"))
```
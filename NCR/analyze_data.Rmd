...
(ggplot(guide_rate, aes(x=class, y=Estimate)) + 
  ...
  (ggplot(guide_rate_100fM, aes(x=class, y=Estimate)) +
     geom_violin(aes(fill=class), alpha=0.25, 
                 draw_quantiles=c(0.25, 0.75), linetype="dashed") +
     geom_violin(fill="transparent", draw_quantiles=0.5) +
     geom_dotplot(binaxis="y", stackdir="center", binwidth=1) +
...
manfredonia_seed_plot <- ggplot(guide_rate, aes(x=manfredonia_seed_cat, y=Estimate)) + 
  geom_violin(aes(fill=manfredonia_seed_cat), alpha=0.5,
              draw_quantiles=c(0.25, 0.75), linetype="dashed") + 
  geom_violin(fill="transparent", draw_quantiles=0.5) + 
  geom_dotplot(binaxis="y", stackdir="center", binwidth=1) +
  theme_bw() + guides(fill=F) + ggtitle("Manfredonia (2020): spacer seed region") +
  xlab("") + ylab("rate above no activator (RFU/min)")
...
guide_rate$lan_seed_cat <- factor(guide_rate$lan_seed_cat,
                                  levels=c("structured", "intermediate", "unstructured"))
lan_seed_plot <- ggplot(guide_rate, aes(x=lan_seed_cat, y=Estimate)) + 
  geom_violin(aes(fill=lan_seed_cat), alpha=0.5,
              draw_quantiles=c(0.25, 0.75), linetype="dashed") + 
  geom_violin(fill="transparent", draw_quantiles=0.5) + 
  geom_dotplot(binaxis="y", stackdir="center", binwidth=1) +
  theme_bw() + guides(fill=F) + ggtitle("Lan (2020): spacer seed region") +
  xlab("") + ylab("rate above no activator (RFU/min)")
...
sun_invitro_seed_plot <- ggplot(guide_rate, aes(x=sun_invitro_seed_cat, y=Estimate)) + 
  geom_violin(aes(fill=sun_invitro_seed_cat), alpha=0.5,
              draw_quantiles=c(0.25, 0.75), linetype="dashed") + 
  geom_violin(fill="transparent", draw_quantiles=0.5) + 
  geom_dotplot(binaxis="y", stackdir="center", binwidth=1) +
  theme_bw() + guides(fill=F) + ggtitle("Sun (2020): in vitro: spacer seed region") +
  xlab("") + ylab("rate above no activator (RFU/min)")
...
sun_invivo_seed_plot <- ggplot(guide_rate, aes(x=sun_invivo_seed_cat, y=Estimate)) + 
  geom_violin(aes(fill=sun_invivo_seed_cat), alpha=0.5,
              draw_quantiles=c(0.25, 0.75), linetype="dashed") + 
  geom_violin(fill="transparent", draw_quantiles=0.5) + 
  geom_dotplot(binaxis="y", stackdir="center", binwidth=1) +
  theme_bw() + guides(fill=F) + ggtitle("Sun (2020): in vivo: spacer seed region") +
  xlab("") + ylab("rate above no activator (RFU/min)")

# Huston (2021)
huston_seed_plot <- ggplot(guide_rate, aes(x=factor(huston_seed), y=Estimate)) + 
  geom_violin(aes(fill=factor(huston_seed)), alpha=0.5,
              draw_quantiles=c(0.25, 0.75), linetype="dashed") + 
  geom_violin(fill="transparent", draw_quantiles=0.5) + 
  geom_dotplot(binaxis="y", stackdir="center", binwidth=1) +
  theme_bw() + guides(fill=F) + ggtitle("Huston (2020): spacer seed region") +
  xlab("") + ylab("rate above no activator (RFU/min)")
...
structure_features <- c("manfredonia", "lan", "sun_invivo", "sun_invitro", "huston")
                                 ...
                                 function(feature) {
                                   ...
                                   viral_structure <- sapply(guide_rate$start,
                                                             function(x) {
                                                               ...
                                                               if(feature == "huston") {
                                                                 viral_structure <- (viral_structure == 0)
                                                               }
                                   ...
                                   position_models <- lapply(colnames(regression_data)[-1],
                                                             function(x) {
                                                               lm(formula(paste("rate ~", x)),
                                                                  data=regression_data)
                                                             })
                                   position_models_r2 <- data.frame(colnames(regression_data)[-1],

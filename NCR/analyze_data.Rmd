...
Suppl. Figure 3B: hybridization MFE
...
Suppl. Figure 3C: cleaveable U in target context
...
ggsave(file=file.path(figure_dir, "suppl_figure_3C.pdf"),
       plot=last_plot(),
       device="pdf", width=3, height=2, units="in")
```

...
figure_S7 <- ggplot(guide_rates,
                    aes(x=activator, y=Estimate, fill=targeting,
...
ggsave(filename=file.path(figure_dir, "suppl_figure_7.pdf"),
       plot=figure_S7,
